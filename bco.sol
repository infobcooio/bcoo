...
/**
 * @title Bcoo
 * @dev The Bcoo contract is Claimable, and provides ERC20 standard token.
 */
contract Bcoo is Claimable, Contactable, HasNoEther, FreezableToken {
    ...
    function Bcoo(){
        ...
        symbol = "BCOO";
        decimals = _decimals;
        contactInformation = "Bitconch contact email:info@bcoo.io";
    }
}
...
contract BcooTokenLock is Ownable, HasNoEther {
     ...
     *
     */
    function BcooTokenLock(address _owner, address _token) {
        require(_owner != 0x0);
        require(_token != 0x0);
